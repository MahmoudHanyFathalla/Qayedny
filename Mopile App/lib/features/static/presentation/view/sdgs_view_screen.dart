...
class SdgsViewScreen extends StatelessWidget {
  static const routeName = '/sdgsViewScreen';

  const SdgsViewScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const SideAppBar(title: 'SGDs'),
