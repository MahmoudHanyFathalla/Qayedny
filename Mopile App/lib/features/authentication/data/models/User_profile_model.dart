...
class UserProfileModel extends amplify_core.Model {
  static const classType = const _UserProfileModelType();
  final String id;
  final String? _ProfilePicture;
  final int? _WorkedHours;
  final String? _About;
  ...
  const UserProfileModel._internal(
      {required this.id,
      ProfilePicture,
      required WorkedHours,
      About,
      createdAt,
      updatedAt})
  ...
  factory UserProfileModel(
      ...
      String? About}) {
    return UserProfileModel._internal(
  ...
  bool operator ==(Object other) {
    ...
    return other is UserProfileModel &&
        ...
        _WorkedHours == other._WorkedHours &&
        _About == other._About;
  }
  ...
  String toString() {
    ...
    buffer.write("WorkedHours=" +
        (_WorkedHours != null ? _WorkedHours!.toString() : "null") +
        ", ");
  ...
  UserProfileModel copyWith(
      {String? ProfilePicture, int? WorkedHours, String? About}) {
    return UserProfileModel._internal(
        id: id,
  ...
  UserProfileModel copyWithModelFieldValues(
      {ModelFieldValue<String?>? ProfilePicture,
      ModelFieldValue<int>? WorkedHours,
      ModelFieldValue<String?>? About}) {
    return UserProfileModel._internal(
        id: id,
        ProfilePicture:
            ProfilePicture == null ? this.ProfilePicture : ProfilePicture.value,
        WorkedHours: WorkedHours == null ? this.WorkedHours : WorkedHours.value,
  ...
  UserProfileModel.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        ...
        _WorkedHours = (json['WorkedHours'] as num?)?.toInt(),
        _About = json['About'],
  ...
  static final WORKEDHOURS = amplify_core.QueryField(fieldName: "WorkedHours");
  ...
  static var schema = amplify_core.Model.defineSchema(
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
        key: UserProfileModel.PROFILEPICTURE,
        isRequired: false,
        ofType: amplify_core.ModelFieldType(
            amplify_core.ModelFieldTypeEnum.string)));

    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
        key: UserProfileModel.WORKEDHOURS,
        isRequired: true,
        ofType:
            amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.int)));

    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.field(
        key: UserProfileModel.ABOUT,
        isRequired: false,
        ofType: amplify_core.ModelFieldType(
            amplify_core.ModelFieldTypeEnum.string)));
...
class _UserProfileModelType extends amplify_core.ModelType<UserProfileModel> {
 ...
 * of [UserProfileModel] in your schema.
 */
class UserProfileModelIdentifier
    implements amplify_core.ModelIdentifier<UserProfileModel> {
  final String id;
